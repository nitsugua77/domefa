...
<div class="container text-center">
    ...
    <br>
    <br>
    <h1 class="mt-5 text-white font-weight-light" style="font-size: 70px"><a href="{$view.links.Home}" style="text-decoration: none; color: white;" > Vous venez de vous déconnecter  </a></h1>
